...
## Содержание
- [Установка](#установка)
- [Создаем модуль](#шаг_1:_создаем_модуль)
- [Импортируем Client](#шаг_2:_импортируем_client)
- [Создаем класс и наследуем от Сlient](#шаг_3:_создаем_класс_и_наследуем_от_client)
- [Реализуем необходимые методы ](#шаг_4:_реализуем_необходимые_методы)
